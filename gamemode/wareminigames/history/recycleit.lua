...
function WARE:Initialize()
	...
	lua_run1:SetKeyValue('Code','CALLER:SetColor(Color(255,255,255,100));CALLER:SetRenderMode(RENDERMODE_TRANSALPHA);CALLER.CartOwner=ACTIVATOR;ACTIVATOR.Cart=CALLER')
	lua_run1:SetKeyValue('targetname','luarun1')
	lua_run1:Spawn()
	
	--local lua_run2 = ents.Create("lua_run")
	--lua_run2:SetKeyValue('Code','CALLER:SetColor(255,255,255,255);CALLER:SetRenderMode(RENDERMODE_TRANSALPHA);CALLER.CartOwner=nil;ACTIVATOR.Cart=nil')
